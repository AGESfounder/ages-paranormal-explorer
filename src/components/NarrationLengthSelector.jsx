  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col shrink-0">
        <span className="text-sm font-heading uppercase tracking-wider text-foreground">Story Length</span>
        <span className="text-[10px] text-muted-foreground">Throughout Exploration</span>
      </div>
