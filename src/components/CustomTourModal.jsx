      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full sm:w-[420px] max-h-[90dvh] overflow-y-auto bg-card border border-border/50 rounded-t-2xl sm:rounded-2xl shadow-2xl px-6 pt-6 pb-modal-safe mx-0 sm:mx-4"
          >
            <button
              onClick={onClose}
