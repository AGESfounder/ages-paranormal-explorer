        ...
        {stop.needs_placement && (
          <div className="flex items-center gap-2 p-3 rounded-xl border border-pink-500/30 bg-pink-500/5">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">This stop's location hasn't been verified. Mark the vantage point or drag the marker to place it.</p>
            </div>
          </div>
        )}
        {isPaid && !stop.user_verified && (
